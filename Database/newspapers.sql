...
-- ----------------------------
BEGIN;
INSERT INTO `newspapers` VALUES (1, 'Loạt smartphone đáng chú ý giảm giá đầu tháng 6', 1, '2019-06-14', NULL, NULL, 0, 1, 0, 'Nhiều mẫu máy từ cao cấp tới giá rẻ đều được các hệ thống bán lẻ giảm giá.', 2);
INSERT INTO `newspapers` VALUES (2, 'Bảo mật trên Android', 2, '2019-06-14', NULL, NULL, 0, 1, 0, 'Trong một động thái để giải quyết mối quan tâm gắn kết về bảo mật trên Android ...', 2);
INSERT INTO `newspapers` VALUES (3, 'IOS 12.2.1', 1, '2019-06-14', NULL, NULL, 0, 1, 0, 'Cập nhật phiên bản IOS 12.2.1 đem lại nhiều lợi ích cho người dùng', 2);
...
INSERT INTO `newspapers` VALUES (9, 'Năm nay Apple sẽ cải thiện điểm yếu chí mạng bấy lâu của iPhone', 1, '2019-06-14', NULL, NULL, 0, 1, 0, 'Theo EverythingApplePro, Apple đang phát triển tính năng chụp đêm Night Mode độc quyền cho thế hệ iPhone kế tiếp.', 2);
...
INSERT INTO `newspapers` VALUES (24, 'Ra mắt Samsung Notebook 7 thiết kế giống hệt Macbook Pro, giá từ 1.000 USD', 5, '2019-06-14', NULL, NULL, 0, 1, 0, 'Ngay trước sự kiện WWDC 2019, Samsung công bố dòng laptop Notebook 7 mới có thiết kế giống MacBook Pro của Apple đến từng chi...', 2);
INSERT INTO `newspapers` VALUES (25, 'Lenovo ra mắt ThinkPad E series cho doanh nhân, thiết kế đẹp, giá vừa phải', 4, '2019-06-14', NULL, NULL, 0, 1, 0, 'Lenovo vừa công bố  bộ ba laptop ThinkPad E series mới, được thiết kế riêng cho các doanh nghiệp SMB cần duy trì hoạt động...', 2);
...
INSERT INTO `newspapers` VALUES (28, 'ASUS VivoBook 14/15 ra mắt, nhỏ gọn, 4 màu sắc', 6, '2019-06-14', NULL, NULL, 0, 1, 0, 'Chiều nay 21/5 tại TP.HCM, ASUS chính thức ra mắt bộ đôi VivoBook 14/15 (A412/A512) tại sự kiện “Vivobook – Cuộc chơi lớn”. Đây là...', 2);
...
INSERT INTO `newspapers` VALUES (30, 'Ra mắt loạt laptop ASUS trang bị AMD Ryzen Mobile', 6, '2019-06-14', NULL, NULL, 0, 1, 0, 'ASUS vừa công bố chính thức hợp tác chiến lược cùng AMD trong sự kiện chủ đề “The Choice of MORE”, đồng thời giới thiệu...', 2);
...
INSERT INTO `newspapers` VALUES (45, 'Phần Lan: tù nhân là những người huấn luyện cho AI thông minh hơn', 7, '2019-06-14', NULL, NULL, 0, 1, 0, 'Trong những \"nhà tù mở\" của Phần Lan, có những tù nhân đang ngồi trước màn hình máy tính, nhận công việc dán nhãn dữ liệu nặng nhọc.', 2);
...
INSERT INTO `newspapers` VALUES (52, 'Đây không phải mèo thật, mà chỉ là mèo do AI tạo ra', 8, '2019-06-14', NULL, NULL, 0, 1, 0, 'Trước đó, báo chí cũng đã đưa tin về một website với công cụ AI có thể tạo ra hình ảnh một con người hoàn toàn không tồn tại trên thế giới.', 2);
...
INSERT INTO `newspapers` VALUES (58, 'AI của Google DeepMind thách đấu cao thủ StarCraft II, thắng 10 trên 11 ván', 8, '2019-06-14', NULL, NULL, 0, 1, 0, 'Hãy cùng xem AI của DeepMind chơi StarCarft II như thế nào.', 2);
...
INSERT INTO `newspapers` VALUES (66, 'Sony phát triển thành công cảm biến Full-frame 100MP, quay phim 6K, rất có tiềm năng áp dụng thực tế', 9, '2019-06-14', NULL, NULL, 0, 1, 0, 'Câu hỏi ta phải đặt ra đó là: liệu có ai tận dụng được hết độ phân giải cao như vậy?', 2);
...
INSERT INTO `newspapers` VALUES (70, 'Canon công bố EOS RP: Máy ảnh Full-frame nhỏ và nhẹ nhất Thế giới, giá rẻ hơn EOS R', 10, '2019-06-14', NULL, NULL, 0, 1, 0, 'Đúng như dự đoán, sản phẩm này có cấu hình khá giống với chiếc 6D Mark II đã có mặt trên thị trường.', 2);
...
INSERT INTO `newspapers` VALUES (72, 'Lộ ảnh thiết kế và cấu hình máy ảnh tầm trung Canon EOS RP: 6D Mark II dạng không gương lật?', 10, '2019-06-14', NULL, NULL, 0, 1, 0, 'Đây là sẽ là chiếc máy ảnh không gương lật có cảm biến Fullframe thứ 2 của hãng Canon.', 2);
...
INSERT INTO `newspapers` VALUES (79, 'Sony phát triển được cảm biến máy ảnh Full-frame 60 megapixel 16bit, quay phim 8K', 9, '2019-06-14', NULL, NULL, 0, 1, 0, 'Đây có lẽ là cảm biến máy ảnh \'toàn năng\' nhất mà Sony sản xuất được từ trước tới nay!', 2);
...
INSERT INTO `newspapers` VALUES (90, 'Sử dụng màu sắc trong thiết kế web thế nào cho đúng?', 11, '2019-06-15', NULL, NULL, 0, 1, 0, 'Xu hướng thiết kế phẳng, sử dụng màu khối đang dần khiến các trang web hiện đại ngày càng trở nên khác biệt.', 2);
...
INSERT INTO `newspapers` VALUES (95, 'Thay vì điều hướng bằng biểu tượng và đường dẫn, xu thế web hiện đại đang nhấn mạnh vào hình thức cuộn trang.', 12, '2019-06-15', NULL, NULL, 0, 1, 0, 'Sau khi cố CEO Steve Jobs qua đời, không một ai tại Apple có tầm ảnh hưởng lớn như Jony Ive - Phó chủ tịch mảng thiết kế của hãng này.', 2);
