...
module.exports = {
    all: () => {
        return db.load(`select news.Id as news_Id, news.Title as news_Title, catson.Name as cat_Name, news.Created_date as news_cr_date 
    ...
    pageByPost: (limit, offset) => {
        return db.load(`select news.Id as news_Id, news.Title as news_Title, catson.Name as cat_Name, news.Created_date as news_cr_date, user.Name as user_Name
